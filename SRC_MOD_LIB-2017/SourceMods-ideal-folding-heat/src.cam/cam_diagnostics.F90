...
! *** MOD START: ADD FILED convection heating CONHEAT ***
   call addfld ('CONHEAT ','K/s  ',pver, 'A','Air heating rate',phys_decomp)
   call add_default ('CONHEAT ', 1, ' ')
! *** MOD END: ADD FILED convection heating CONHEAT ***
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
