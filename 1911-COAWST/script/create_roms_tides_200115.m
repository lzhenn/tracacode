...
% (1) Specify existing Grid File and new tide Forcing Files 
      Gname='/users/b145872/project-dir/app/COAWST-sandy/Sandy_roms_grid.nc';
      Fname='/users/b145872/project-dir/app/COAWST-sandy/tide_forc_Sandy.nc';
...
% (3) Select Adcirc or topex/osu tidal constituent data 
      ...
      osu=0
      if (adcirc)
        load /users/b145872/project-dir/guide/COAWST-toturial/data/tide/adcirc_ec2001v2e_fix.mat tri lon lat u v elev depth periods freq names
        names=names';
      end
      if (osu)
...
if (IPLOT),
   ...
   for k = 1: Ntide
    ...
    shading('interp'); colorbar; disp(43); grid on;
    xlabel('Amplitude (m)');
