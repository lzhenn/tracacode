...
#    cases=["ERA5_C2008_dynlim",  "ERA5_TY2001_nolimit",  "ERA5_WRFROMS_add", "ERA5_WRF_add"]
    ...
    fig, ax=plt.subplots()
    fig.subplots_adjust(left=0.1, bottom=0.18, right=0.99, top=0.92, wspace=None, hspace=None) 
    ...
    plt.ylabel('AKHS (m/s)',fontsize=SMFONT)
    plt.xticks(fontsize=SMFONT)
    plt.yticks(fontsize=SMFONT)
      
    plt.title( 'AKHS - 10m WindSpeed', fontsize=BIGFONT)
