...
def main():
    ...
    cases=["ERA5_C2008_dynlim", "ERA5_C2008_add", "ERA5_TY2001_add",  "ERA5_WRFROMS_add", "ERA5_WRF_add"]
    ...
    plt.ylabel('ZNT',fontsize=SMFONT)
    plt.xticks(fontsize=SMFONT)
    plt.yticks(fontsize=SMFONT)
      
    plt.title('ZNT - 10m WindSpeed', fontsize=BIGFONT)
    fig.set_size_inches(FIG_WIDTH, FIG_HEIGHT)
    fig.savefig('../fig/scatter_znt_add.png')
    #plt.show()
