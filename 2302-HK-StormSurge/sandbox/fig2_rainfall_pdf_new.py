...
# ax1.set_yticks([0.00001, 0.0001, 0.001, 0.01, 0.1])
# ax1.get_yaxis().set_major_formatter(matplotlib.ticker.ScalarFormatter())
ax1.legend(loc='best', fontsize=12.5)
ax1.text(50, 0.00002, '(a)', fontsize = 16, backgroundcolor='white')
ax1.text(76, 1.0, 'Mangkhut (2018)', fontsize = 17, fontweight='semibold')
ax1.text(16.5, 0.00008, 'Total  rainfall', fontsize = 16.5, rotation = 'vertical', fontweight='semibold')

ax2.set_xlim(45,700)
ax2.set_ylim(0.00001,0.35)
ax2.set_xscale('log')
ax2.set_yscale('log')
...
# ax2.set_yticks([0.00001, 0.0001, 0.001, 0.01, 0.1])
# ax2.get_yaxis().set_major_formatter(matplotlib.ticker.ScalarFormatter())
ax2.text(50, 0.00002, '(b)', fontsize = 17, backgroundcolor='white')
ax2.text(96.5, 1.0, 'Hato (2017)', fontsize = 16.5, fontweight='semibold')

ax3.set_xlim(45,1200)
ax3.set_ylim(0.00001,0.35)
ax3.set_xscale('log')
ax3.set_yscale('log')
...
# ax3.set_yticks([0.00001, 0.0001, 0.001, 0.01, 0.1])
# ax3.get_yaxis().set_major_formatter(matplotlib.ticker.ScalarFormatter())
ax3.text(50, 0.00002, '(c)', fontsize = 17, backgroundcolor='white')
ax3.text(87.0, 1.0, 'Vicente (2012)', fontsize = 16.5, fontweight='semibold')
...
ax4.text(5.05, 0.000002, '(d)', fontsize = 16, backgroundcolor='white')
ax4.text(1.55, 0.000005, 'Hourly  rainfall', fontsize = 16.5, rotation = 'vertical', fontweight='semibold')


ax5.set_xlim(4.5,185)
ax5.set_ylim(0.000001,1.0)
ax5.set_xscale('log')
ax5.set_yscale('log')
...
ax5.text(5.05, 0.000002, '(e)', fontsize = 16, backgroundcolor='white')


ax6.set_xlim(4.5,195)
ax6.set_ylim(0.000001,1.0)
ax6.set_xscale('log')
ax6.set_yscale('log')
...
ax6.text(5.1, 0.000002, '(f)', fontsize = 16, backgroundcolor='white')
