...
# Out path
inv_path='/home/yangsong3/data/model/L_Zealot/HKUST_yeq-2016/resident-time_output/data/hysplit/xiamen/'



#Parser

polygon = shapefile.Reader('../../UTILITY-2016/shp/Xiamen/Xiamen.shp') 
polygon = polygon.shapes()  

pt_dic={}
fr = open(inv_path+'points-xiamen-9km', 'r')
