...
# Case name
CASENAME=mangkhut-era-caulliez2008
...
# Registered Steps:
FLAG_ARRAY[0]=true # step0_extract-tcInfo_200406.ncl
FLAG_ARRAY[1]=true # step1_plot_SLP_UV10_200406.ncl
FLAG_ARRAY[2]=true #
FLAG_ARRAY[3]=true #
