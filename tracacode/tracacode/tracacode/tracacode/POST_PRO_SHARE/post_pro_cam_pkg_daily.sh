...
PRE_DIR=\"/HOME/sysu_hjkx_ys/WORKSPACE/L_Zealot/cesm/F/SP_AMIP/run/\"

# Path of the post processed data
PRO_DIR=\"/HOME/sysu_hjkx_ys/WORKSPACE/L_Zealot/temp/SP_AMIP/\"
...
FDNAME2D="(/\"PRECC\",\"PRECL\",\"PSL\"/)" #often use
