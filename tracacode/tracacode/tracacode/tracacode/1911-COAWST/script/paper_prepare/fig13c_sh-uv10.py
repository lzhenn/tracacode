...
#    cases=["ERA5_C2008_dynlim",  "ERA5_TY2001_nolimit",  "ERA5_WRFROMS_add", "ERA5_WRF_add"]
    ...
    plt.ylabel('Total SH (10^16 Joules)',fontsize=MIDFONT)
    plt.xticks(fontsize=MIDFONT)
    plt.yticks(fontsize=MIDFONT)
      
    plt.title( '(c) Accumulated Total SH - 10m WindSpeed', fontsize=BIGFONT, loc='left')
    fig.set_size_inches(FIG_WIDTH, FIG_HEIGHT)
    fig.savefig('../../fig/paper/fig13c_'+varname+'.pdf')
    #plt.show()
