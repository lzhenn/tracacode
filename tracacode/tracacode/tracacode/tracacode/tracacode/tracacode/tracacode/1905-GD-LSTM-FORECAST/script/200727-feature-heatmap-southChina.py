...
def heatmap(data, row_labels, col_labels, ax=None,
    ...
    **kwargs
    ...
    plt.ylabel('Features (Prec)',fontsize=MIDFONT)
...
#----------------------------------------------------
    ...
    # Result Input File
    result_in_file='../result/south_china_prec_result.json'
...
#----------------------------------------------------
    ...
    fctr_sum.sort()
    fctr_sum=fctr_sum[::-1]
    data0=np.copy(data[0:n_feature,::2])
    ii=0
    print(data.shape)
    for itm in sort_arr[0:n_feature]:
        data0[ii,:]=data[itm,::2]
        ii=ii+1
    ...
    im = heatmap(data0, features[0:n_feature], stas, ax=ax,
