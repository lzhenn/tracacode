...
def main():
    ...
    for case, line_type in zip(cases, line_types):
        ...
        plt.plot(np.arange(81)*3, content_list, line_type, label=case, markersize=5)
    ...
    plt.title('Azimuthally averaged '+varname, fontsize=BIGFONT, loc='left')
#    fig.tight_layout()
#    plt.show()
    fig.set_size_inches(width, height)
    fig.savefig('../../fig/paper/fig9_'+varname+'_radius.pdf')
