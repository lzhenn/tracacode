...
while int_time_obj <= end_time_obj:
    ...
    # Output Date Change
    lines[-1]='pointc'+int_time_obj.strftime('%y%m%d%H\n')
    ...
    os.system('C:/hysplit4/exec/trajplot.exe -a3 -ipointc'+int_time_obj.strftime('%y%m%d%H')+' -oplot'+int_time_obj.strftime('%y%m%d%H'))
