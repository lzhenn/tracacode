...
case_names=['','_warm','_noluzon','_noluzon_warm']
work_path0='/home/lzhenn/poseidon/2018091200'
#work_path='/home/lzhenn/array129/poseidon/2018091200/'
# File paths
#tide_file = '/disk/r074/lzhenn/data/luna/hko_all/tides.1980010100'
tide_file = '/disk/r074/lzhenn/data/luna/2018091400/tides.2018091400'
site_file = '/home/lzhenn/array74/workspace/luna-kit/db/hko_site.real.csv'
...
for case in case_names:
    ...
    for index, site in site_df.iterrows():
        ...
        plt.grid(True)
        plt.ylim((0,9))
        plt.savefig(os.path.join(f'../fig/241016_{site_name}{case}.png'), 
